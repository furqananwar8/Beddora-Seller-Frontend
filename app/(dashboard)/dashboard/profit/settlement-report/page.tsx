...
const ProfitSettlementReport = dynamic(
  () => import('@/features/profit/dashboard/ProfitSettlementReport').then((mod) => mod.ProfitSettlementReport),
  {
    ssr: false,
