...
// Loading skeleton for eBay dashboard
const EbayDashboardSkeleton = () => (
  <Container size="full">
...
// Lazy-load the profit dashboard component (reusing for eBay)
const EbayDashboardScreen = dynamic(
  () => import('@/features/profit/dashboard/ProfitDashboardScreen').then((mod) => mod.ProfitDashboardScreen),
  {
    ssr: false,
    loading: () => <EbayDashboardSkeleton />,
  }
)

export default function EbayDashboardPage() {
  return <EbayDashboardScreen />
}
